...
public class WalletApi {
    ...
    public func createWallet(credentials: Credentials, walletName: String, m: Int = 1, n: Int = 1, handler: @escaping (CreateWalletModel?, String?)->()) {
        ...
        let encWalletName = SjclEncryptMessage.encrypt(msg: walletName, encryptKey: credentials.sharedEncryptingKey!)
    ...
    public func createAndJoinWallet(credentials: Credentials, walletName: String, m: Int = 1, n: Int = 1, handler: @escaping (JoinWalletModel?, String?)->()) {
        ...
        self.createWallet(credentials: credentials, walletName: walletName, m: m, n: n, handler: createWalletCallback)
